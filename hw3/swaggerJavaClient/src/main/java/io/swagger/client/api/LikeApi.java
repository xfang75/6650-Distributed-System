...
public class LikeApi {
     ...
     */
    public com.squareup.okhttp.Call reviewCall(String likeornot, String albumID, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/review/{likeornot}/{albumID}"
            .replaceAll("\\{" + "likeornot" + "\\}", apiClient.escapeString(likeornot.toString()))
